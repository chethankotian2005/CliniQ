...
class Doctor(models.Model):
    ...
    def is_on_duty(self):
        ...
        # Force evaluation in IST (Asia/Kolkata) to ensure consistent 'now' for the hospital
        try:
        ...
        if ist_tz:
            try:
                now = timezone.now().astimezone(ist_tz).time()
            except Exception:
        ...
        # If lunch times are specified, consider them as off-duty window
